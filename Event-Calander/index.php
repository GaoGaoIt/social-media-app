...
$numberofEventsNextday = 0;
$nextdayEvent_1 = array("", "", "", "", "", "");
$nextdayEvent_2 = array("", "", "", "", "", "");
$nextdayEvent_3 = array("", "", "", "", "", "");
$nextdayEvent_4 = array("", "", "", "", "", "");

$numberofSpecialEvents = 0;
$specialEvent_1 = array("", "", "", "", "", "");
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if ($numberofSpecialEvents == 1) {
            $specialEvent_1[0] = $row["content_id"];
            $specialEvent_1[1] = str_replace(array("\n", "\r"), array(" ", " "), $row["Caption"]);
            $specialEvent_1[2] = str_replace(array("\n", "\r"), array(" ", " "), $row["content_path_name"]);
        ...
        if ($numberofSpecialEvents == 2) {
            $specialEvent_2[0] = $row["content_id"];
            $specialEvent_2[1] = str_replace(array("\n", "\r"), array(" ", " "), $row["Caption"]);
            $specialEvent_2[2] =str_replace(array("\n", "\r"), array(" ", " "), $row["content_path_name"]);
        ...
        if ($numberofSpecialEvents == 3) {
            $specialEvent_3[0] = $row["content_id"];
            $specialEvent_3[1] = str_replace(array("\n", "\r"), array(" ", " "), $row["Caption"]);
            $specialEvent_3[2] = str_replace(array("\n", "\r"), array(" ", " "), $row["content_path_name"]);
        ...
        if ($numberofSpecialEvents == 4) {
            $specialEvent_4[0] = $row["content_id"];
            $specialEvent_4[1] = str_replace(array("\n", "\r"), array(" ", " "), $row["Caption"]);
            $specialEvent_4[2] = str_replace(array("\n", "\r"), array(" ", " "), $row["content_path_name"]);
...
<body>
    ...
    <script>
        ...
        document.getElementById("todayEventBox_1-2").innerHTML = '<img src="../assets/images/posts/<?= $todayEvent_1[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("todayEventBox_2-2").innerHTML = '<img src="../assets/images/posts/<?= $todayEvent_2[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("todayEventBox_3-2").innerHTML = '<img src="../assets/images/posts/<?= $todayEvent_3[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("todayEventBox_4-2").innerHTML = '<img src="../assets/images/posts/<?= $todayEvent_4[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("nextdayEventBox_1-2").innerHTML = '<img src="../assets/images/posts/<?= $nextdayEvent_1[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("nextdayEventBox_2-2").innerHTML = '<img src="../assets/images/posts/<?= $nextdayEvent_2[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("nextdayEventBox_3-2").innerHTML = '<img src="../assets/images/posts/<?= $nextdayEvent_3[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("nextdayEventBox_4-2").innerHTML = '<img src="../assets/images/posts/<?= $nextdayEvent_4[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("specialEventBox_1-2").innerHTML = '<img src="../assets/images/posts/<?= $specialEvent_1[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("specialEventBox_2-2").innerHTML = '<img src="../assets/images/posts/<?= $specialEvent_2[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("specialEventBox_3-2").innerHTML = '<img src="../assets/images/posts/<?= $specialEvent_3[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
        ...
        document.getElementById("specialEventBox_4-2").innerHTML = '<img src="../assets/images/posts/<?= $specialEvent_4[2] ?>" style="width: 100%; height: 220px; object-fit: cover;" alt="">';
