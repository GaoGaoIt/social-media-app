                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <i class="fa-solid fa-pen-to-square">
                                        <a href="#" style="color: black; text-decoration: none;" onclick="openEditModal(<?php echo $comment['COMMENT_ID']; ?>)">
                                            Edit Comment
                                        </a>
                                    </i><br><br>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <form method="post" action="Edit-Comment-1.php">
                                    ...
                                    <input type="hidden" id="edit-comment-id" name="comment_id" value="<?php echo $comment['COMMENT_ID']; ?>">
